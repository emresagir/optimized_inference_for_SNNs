...
trainset = tonic.DiskCachedDataset(dataset=None, cache_path='../SCNN_STMNIST/cache/stmnist/train')
valset   = tonic.DiskCachedDataset(dataset=None, cache_path='../SCNN_STMNIST/cache/stmnist/val')
testset  = tonic.DiskCachedDataset(dataset=None, cache_path='../SCNN_STMNIST/cache/stmnist/test')
