...
void LIFNeuron_Layer_Update_Vectorized_NoRecurrent(LIFNeuron* neurons, const q7_t* input_spikes, 
    ...
    // temp1 = membranepot - reset_values 
    // temp2 = (membranepot - reset_values) * decay 
    // temp3 = ((membranepot - reset_values) * decay) + reset_values
    // membranepot = (((membranepot - reset_values) * decay) + reset_values) + input
